...
// TOD investing lot of time here because this way of authenticating user is not more used.
// ze instead use Oauth2 authentication mechanisl
@Service
public class JwtGeneratorImpl implements JwtGeneratorInterface {
    ...
    // TODO: is bad practice. should be set in a Kubernetes Secret for example
    ...
    @Override
    public Map<String, String> generateToken(User user) throws InvalidKeySpecException, NoSuchAlgorithmException {
        PrivateKey privateKey = getPrivateKey();

        Instant now = Instant.now();
        String jwtTokens = Jwts.builder()
        ...
        jwtTokenGen.put("token", jwtTokens);
